...
namespace LCompilers::LanguageServerProtocol {
  ...
  std::map<RequestMethod, std::string> RequestMethodNames = {
    ...
    {RequestMethod::EXTRACT_DOCUMENT_LINKS, "EXTRACT_DOCUMENT_LINKS"},
    {RequestMethod::FIND_REFERENCES, "FIND_REFERENCES"},
    {RequestMethod::GOTO_DEFINITION, "GOTO_DEFINITION"},
    {RequestMethod::GOTO_IMPLEMENTATION, "GOTO_IMPLEMENTATION"},
    {RequestMethod::GOTO_TYPE_DEFINITION, "GOTO_TYPE_DEFINITION"},
    {RequestMethod::HIGHLIGHT_DOCUMENT, "HIGHLIGHT_DOCUMENT"},
    {RequestMethod::INITIALIZE, "INITIALIZE"},
    {RequestMethod::PREPARE_CALL_HIERARCHY, "PREPARE_CALL_HIERARCHY"},
    {RequestMethod::PREPARE_TYPE_HIERARCHY, "PREPARE_TYPE_HIERARCHY"},
    {RequestMethod::RENAME_FILES, "RENAME_FILES"},
    {RequestMethod::RESOLVE_DOCUMENT_LINK, "RESOLVE_DOCUMENT_LINK"},
  ...
  std::map<RequestMethod, std::string> RequestMethodValues = {
    ...
    {RequestMethod::EXTRACT_DOCUMENT_LINKS, "textDocument/documentLink"},
    {RequestMethod::FIND_REFERENCES, "textDocument/references"},
    {RequestMethod::GOTO_DEFINITION, "textDocument/definition"},
    {RequestMethod::GOTO_IMPLEMENTATION, "textDocument/implementation"},
    {RequestMethod::GOTO_TYPE_DEFINITION, "textDocument/typeDefinition"},
    {RequestMethod::HIGHLIGHT_DOCUMENT, "textDocument/documentHighlight"},
    {RequestMethod::INITIALIZE, "initialize"},
    {RequestMethod::PREPARE_CALL_HIERARCHY, "textDocument/prepareCallHierarchy"},
    {RequestMethod::PREPARE_TYPE_HIERARCHY, "textDocument/prepareTypeHierarchy"},
    {RequestMethod::RENAME_FILES, "workspace/willRenameFiles"},
    {RequestMethod::RESOLVE_DOCUMENT_LINK, "documentLink/resolve"},
