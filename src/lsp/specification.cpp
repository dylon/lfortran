...
namespace LCompilers::LanguageServerProtocol {
  ...
  std::map<RequestMethod, std::string> RequestMethodNames = {
    {RequestMethod::CALL_HIERARCHY_INCOMING_CALLS, "CALL_HIERARCHY_INCOMING_CALLS"},
    {RequestMethod::CALL_HIERARCHY_OUTGOING_CALLS, "CALL_HIERARCHY_OUTGOING_CALLS"},
    {RequestMethod::CODE_LENS_RESOLVE, "CODE_LENS_RESOLVE"},
    {RequestMethod::DOCUMENT_LINK_RESOLVE, "DOCUMENT_LINK_RESOLVE"},
    {RequestMethod::INITIALIZE, "INITIALIZE"},
    {RequestMethod::SHUTDOWN, "SHUTDOWN"},
    {RequestMethod::TEXT_DOCUMENT_CODE_LENS, "TEXT_DOCUMENT_CODE_LENS"},
    {RequestMethod::TEXT_DOCUMENT_DECLARATION, "TEXT_DOCUMENT_DECLARATION"},
    {RequestMethod::TEXT_DOCUMENT_DEFINITION, "TEXT_DOCUMENT_DEFINITION"},
    {RequestMethod::TEXT_DOCUMENT_DOCUMENT_HIGHLIGHT, "TEXT_DOCUMENT_DOCUMENT_HIGHLIGHT"},
    {RequestMethod::TEXT_DOCUMENT_DOCUMENT_LINK, "TEXT_DOCUMENT_DOCUMENT_LINK"},
    {RequestMethod::TEXT_DOCUMENT_DOCUMENT_SYMBOL, "TEXT_DOCUMENT_DOCUMENT_SYMBOL"},
    {RequestMethod::TEXT_DOCUMENT_FOLDING_RANGE, "TEXT_DOCUMENT_FOLDING_RANGE"},
    {RequestMethod::TEXT_DOCUMENT_HOVER, "TEXT_DOCUMENT_HOVER"},
    {RequestMethod::TEXT_DOCUMENT_IMPLEMENTATION, "TEXT_DOCUMENT_IMPLEMENTATION"},
    {RequestMethod::TEXT_DOCUMENT_PREPARE_CALL_HIERARCHY, "TEXT_DOCUMENT_PREPARE_CALL_HIERARCHY"},
    {RequestMethod::TEXT_DOCUMENT_PREPARE_TYPE_HIERARCHY, "TEXT_DOCUMENT_PREPARE_TYPE_HIERARCHY"},
    {RequestMethod::TEXT_DOCUMENT_REFERENCES, "TEXT_DOCUMENT_REFERENCES"},
    {RequestMethod::TEXT_DOCUMENT_SELECTION_RANGE, "TEXT_DOCUMENT_SELECTION_RANGE"},
    {RequestMethod::TEXT_DOCUMENT_SEMANTIC_TOKENS_FULL, "TEXT_DOCUMENT_SEMANTIC_TOKENS_FULL"},
    {RequestMethod::TEXT_DOCUMENT_TYPE_DEFINITION, "TEXT_DOCUMENT_TYPE_DEFINITION"},
    {RequestMethod::TEXT_DOCUMENT_WILL_SAVE_WAIT_UNTIL, "TEXT_DOCUMENT_WILL_SAVE_WAIT_UNTIL"},
    ...
    {RequestMethod::WORKSPACE_CODE_LENS_REFRESH, "WORKSPACE_CODE_LENS_REFRESH"},
    {RequestMethod::WORKSPACE_EXECUTE_COMMAND, "EXECUTE_COMMAND"},
    {RequestMethod::WORKSPACE_SYMBOL_RESOLVE, "WORKSPACE_SYMBOL_RESOLVE"},
    {RequestMethod::WORKSPACE_SYMBOL, "WORKSPACE_SYMBOL"},
    {RequestMethod::WORKSPACE_WILL_CREATE_FILES, "WORKSPACE_WILL_CREATE_FILES"},
    {RequestMethod::WORKSPACE_WILL_RENAME_FILES, "WORKSPACE_WILL_RENAME_FILES"},
  };

  std::map<RequestMethod, std::string> RequestMethodValues = {
    {RequestMethod::CALL_HIERARCHY_INCOMING_CALLS, "callHierarchy/incomingCalls"},
    {RequestMethod::CALL_HIERARCHY_OUTGOING_CALLS, "callHierarchy/outgoingCalls"},
    {RequestMethod::CODE_LENS_RESOLVE, "codeLens/resolve"},
    {RequestMethod::DOCUMENT_LINK_RESOLVE, "documentLink/resolve"},
    {RequestMethod::INITIALIZE, "initialize"},
    {RequestMethod::SHUTDOWN, "shutdown"},
    {RequestMethod::TEXT_DOCUMENT_CODE_LENS, "textDocument/codeLens"},
    {RequestMethod::TEXT_DOCUMENT_DECLARATION, "textDocument/declaration"},
    {RequestMethod::TEXT_DOCUMENT_DEFINITION, "textDocument/definition"},
    {RequestMethod::TEXT_DOCUMENT_DOCUMENT_HIGHLIGHT, "textDocument/documentHighlight"},
    {RequestMethod::TEXT_DOCUMENT_DOCUMENT_LINK, "textDocument/documentLink"},
    {RequestMethod::TEXT_DOCUMENT_DOCUMENT_SYMBOL, "textDocument/documentSymbol"},
    {RequestMethod::TEXT_DOCUMENT_FOLDING_RANGE, "textDocument/foldingRange"},
    {RequestMethod::TEXT_DOCUMENT_HOVER, "textDocument/hover"},
    {RequestMethod::TEXT_DOCUMENT_IMPLEMENTATION, "textDocument/implementation"},
    {RequestMethod::TEXT_DOCUMENT_PREPARE_CALL_HIERARCHY, "textDocument/prepareCallHierarchy"},
    {RequestMethod::TEXT_DOCUMENT_PREPARE_TYPE_HIERARCHY, "textDocument/prepareTypeHierarchy"},
    {RequestMethod::TEXT_DOCUMENT_REFERENCES, "textDocument/references"},
    {RequestMethod::TEXT_DOCUMENT_SELECTION_RANGE, "textDocument/selectionRange"},
    {RequestMethod::TEXT_DOCUMENT_SEMANTIC_TOKENS_FULL, "textDocument/semanticTokens/full"},
    {RequestMethod::TEXT_DOCUMENT_TYPE_DEFINITION, "textDocument/typeDefinition"},
    {RequestMethod::TEXT_DOCUMENT_WILL_SAVE_WAIT_UNTIL, "textDocument/willSaveWaitUntil"},
    ...
    {RequestMethod::WORKSPACE_CODE_LENS_REFRESH, "workspace/codeLens/refresh"},
    {RequestMethod::WORKSPACE_EXECUTE_COMMAND, "workspace/executeCommand"},
    {RequestMethod::WORKSPACE_SYMBOL_RESOLVE, "workspaceSymbol/resolve"},
    {RequestMethod::WORKSPACE_SYMBOL, "workspace/symbol"},
    {RequestMethod::WORKSPACE_WILL_CREATE_FILES, "workspace/willCreateFiles"},
    {RequestMethod::WORKSPACE_WILL_RENAME_FILES, "workspace/willRenameFiles"},
  };
  ...
  std::map<NotificationMethod, std::string> NotificationMethodNames = {
    ...
    {NotificationMethod::NOTEBOOK_DOCUMENT_DID_CHANGE, "NOTEBOOK_DOCUMENT_DID_CHANGE"},
    {NotificationMethod::NOTEBOOK_DOCUMENT_DID_CLOSE, "NOTEBOOK_DOCUMENT_DID_CLOSE"},
    {NotificationMethod::NOTEBOOK_DOCUMENT_DID_OPEN, "NOTEBOOK_DOCUMENT_DID_OPEN"},
    {NotificationMethod::NOTEBOOK_DOCUMENT_DID_SAVE, "NOTEBOOK_DOCUMENT_DID_SAVE"},
    {NotificationMethod::SET_TRACE, "SET_TRACE"},
    {NotificationMethod::TEXT_DOCUMENT_DID_CHANGE, "TEXT_DOCUMENT_DID_CHANGE"},
    {NotificationMethod::TEXT_DOCUMENT_DID_CLOSE, "TEXT_DOCUMENT_DID_CLOSE"},
    {NotificationMethod::TEXT_DOCUMENT_DID_OPEN, "TEXT_DOCUMENT_DID_OPEN"},
    {NotificationMethod::TEXT_DOCUMENT_DID_SAVE, "TEXT_DOCUMENT_DID_SAVE"},
    {NotificationMethod::WINDOW_WORK_DONE_PROGRESS_CANCEL, "WINDOW_WORK_DONE_PROGRESS_CANCEL"},
    {NotificationMethod::WORKSPACE_DID_CHANGE_CONFIGURATION, "WORKSPACE_DID_CHANGE_CONFIGURATION"},
    {NotificationMethod::WORKSPACE_DID_CHANGE_WATCHED_FILES, "WORKSPACE_DID_CHANGE_WATCHED_FILES"},
    {NotificationMethod::WORKSPACE_DID_CHANGE_WORKSPACE_FOLDERS, "WORKSPACE_DID_CHANGE_WORKSPACE_FOLDERS"},
    {NotificationMethod::WORKSPACE_DID_CREATE_FILES, "WORKSPACE_DID_CREATE_FILES"},
    {NotificationMethod::WORKSPACE_DID_DELETE_FILES, "WORKSPACE_DID_DELETE_FILES"},
    {NotificationMethod::WORKSPACE_DID_RENAME_FILES, "WORKSPACE_DID_RENAME_FILES"},
  };
  ...
  std::map<NotificationMethod, std::string> NotificationMethodValues = {
    ...
    {NotificationMethod::EXIT, "exit"},
    {NotificationMethod::INITIALIZED, "initialized"},
    {NotificationMethod::NOTEBOOK_DOCUMENT_DID_CHANGE, "notebookDocument/didChange"},
    {NotificationMethod::NOTEBOOK_DOCUMENT_DID_CLOSE, "notebookDocument/didClose"},
    {NotificationMethod::NOTEBOOK_DOCUMENT_DID_OPEN, "notebookDocument/didOpen"},
    {NotificationMethod::NOTEBOOK_DOCUMENT_DID_SAVE, "notebookDocument/didSave"},
    {NotificationMethod::SET_TRACE, "$/setTrace"},
    {NotificationMethod::TEXT_DOCUMENT_DID_CHANGE, "textDocument/didChange"},
    {NotificationMethod::TEXT_DOCUMENT_DID_CLOSE, "textDocument/didClose"},
    {NotificationMethod::TEXT_DOCUMENT_DID_OPEN, "textDocument/didOpen"},
    {NotificationMethod::TEXT_DOCUMENT_DID_SAVE, "textDocument/didSave"},
    {NotificationMethod::WINDOW_WORK_DONE_PROGRESS_CANCEL, "window/workDoneProgress/cancel"},
    {NotificationMethod::WORKSPACE_DID_CHANGE_CONFIGURATION, "workspace/didChangeConfiguration"},
    {NotificationMethod::WORKSPACE_DID_CHANGE_WATCHED_FILES, "workspace/didChangeWatchedFiles"},
    {NotificationMethod::WORKSPACE_DID_CHANGE_WORKSPACE_FOLDERS, "workspace/didChangeWorkspaceFolders"},
    {NotificationMethod::WORKSPACE_DID_CREATE_FILES, "workspace/didCreateFiles"},
    {NotificationMethod::WORKSPACE_DID_DELETE_FILES, "workspace/didDeleteFiles"},
    {NotificationMethod::WORKSPACE_DID_RENAME_FILES, "workspace/didRenameFiles"},
  };
  ...
  std::map<ServerRequestMethod, std::string> ServerRequestMethodNames = {
    {ServerRequestMethod::CLIENT_REGISTER_CAPABILITY, "CLIENT_REGISTER_CAPABILITY"},
    {ServerRequestMethod::CLIENT_UNREGISTER_CAPABILITY, "CLIENT_UNREGISTER_CAPABILITY"},
    {ServerRequestMethod::WINDOW_LOG_MESSAGE, "WINDOW_LOG_MESSAGE"},
    {ServerRequestMethod::WINDOW_SHOW_DOCUMENT, "WINDOW_SHOW_DOCUMENT"},
    {ServerRequestMethod::WINDOW_SHOW_MESSAGE_REQUEST, "WINDOW_SHOW_MESSAGE_REQUEST"},
    {ServerRequestMethod::WINDOW_WORK_DONE_PROGRESS_CREATE, "WINDOW_WORK_DONE_PROGRESS_CREATE"},
    {ServerRequestMethod::WORKSPACE_APPLY_EDIT, "WORKSPACE_APPLY_EDIT"},
  ...
  std::map<ServerRequestMethod, std::string> ServerRequestMethodValues = {
    {ServerRequestMethod::CLIENT_REGISTER_CAPABILITY, "client/registerCapability"},
    {ServerRequestMethod::CLIENT_UNREGISTER_CAPABILITY, "client/unregisterCapability"},
    {ServerRequestMethod::WINDOW_LOG_MESSAGE, "window/logMessage"},
    {ServerRequestMethod::WINDOW_SHOW_DOCUMENT, "window/showDocument"},
    {ServerRequestMethod::WINDOW_SHOW_MESSAGE_REQUEST, "window/showMessageRequest"},
    {ServerRequestMethod::WINDOW_WORK_DONE_PROGRESS_CREATE, "window/workDoneProgress/create"},
    {ServerRequestMethod::WORKSPACE_APPLY_EDIT, "workspace/applyEdit"},
